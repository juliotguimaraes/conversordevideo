...
public class ConvertZencoderS3 implements ConvertService {

    private final ConvertProperties zencoderProp;
    private final S3StorageProperties s3Prop;

    @Autowired
    public ConvertZencoderS3(ConvertProperties zencoderProp, S3StorageProperties s3Prop) {
        this.zencoderProp = zencoderProp;
        this.s3Prop = s3Prop;
    }
    ...
    private String createJSONRequestBody(
      ...
      String output
        ...
        try {
            ...
            request_body.put("api_key", zencoderProp.getFullKey());
            // Set input url from Amazon AWS.
            request_body.put(
              "input",
              "s3+" + s3Prop.getRegion() + "://" +
                s3Prop.getBucketName() + input
            );
          ...
          throw new ConvertException("Error creating request body for encoding job.");
        }
    }
    ...
    */
    private String sendEncodeRequest(String request_body) {
      try {
        // Create connection.
        URL url = new URL(zencoderProp.getConvertUrl());
        ...
        throw new ConvertException("Error when sending Zencoder job.");
      }
    }
    ...
    */
    ...
    public String encodeFile(
      ...
      String output_path
          ...
          return_JSON.put("zencoder_key", zencoderProp.getReadKey());
          // Return string
